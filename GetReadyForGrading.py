...
checkAll = True    #Check all the assignment of a class if True
...
for assignment in assignmentList:
    ...
    for name in names:
        ...
        if os.path.exists(f'{repoPath}\\{folderName}'):   #Check to see if the project has been cloned before
            ...
            feedbackBranchCheckAndCheckout()
            summary.append(f'{name} : Repo Cloned (and Feedback branch created if necessary)')
    ...
    summary.insert(0, f'{assignmentName}')
